...
var secondBoxController = (function(){
    var firstBox = getBox("secondBox");
    var liList = document.querySelectorAll(".menuBoxSecond li");
    var ul = document.querySelector(".tab-box-second");
    var controller = {
        muneController : function(){
        ...
        contentCtroller : function(){
            var contentBox = document.querySelector(".contentBoxSecond");
